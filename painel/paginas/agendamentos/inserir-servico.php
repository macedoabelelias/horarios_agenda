...
if(strtotime($data_pgto) <=  strtotime($data_atual)){
	...
	$pdo->query("INSERT INTO pagar SET descricao = '$descricao2', referencia = 'Comissão', valor = '$valor_comissao', data_lanc = '$data_pgto', vencimento = '$data_pgto', usuario_lanc = '$usuario_logado', arquivo = 'sem-foto.png', pago = 'Não', funcionario = '$funcionario', id_ref = '$servico'");
	}
}else{
	$pago = 'Não';
	$data_pgto2 = '';
